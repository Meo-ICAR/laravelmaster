...
<body
    class="min-h-screen bg-linear-to-br from-slate-50 to-white text-gray-900 antialiased dark:from-gray-900 dark:to-gray-800 dark:text-gray-100">
    ...
    <nav class="mx-auto max-w-7xl px-6 py-6 lg:px-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
                <div
                    class="from-black-500 flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-r to-gray-500 shadow-lg">
                    <span class="text-lg font-bold text-white">🎬</span>
                </div>
                <span
                    class="from-black-600 bg-linear-to-r to-gray-500 bg-clip-text text-2xl font-bold text-black">
                    CastingPro
                </span>
            </div>
            ...
            <div class="flex items-center space-x-4">
                @auth
                <a href="{{ url('/admin') }}"
                    class="rounded-xl border border-gray-200/50 bg-white/80 px-6 py-2.5 text-sm font-medium shadow-sm backdrop-blur-sm transition-all duration-200 hover:border-gray-300 hover:bg-white hover:shadow-md">
                    Dashboard
                </a>
                @else
                ...
                <a href="{{ url('/admin/register') }}"
                    class="rounded-xl bg-linear-to-r from-red-500 to-orange-500 px-6 py-2.5 font-medium text-white shadow-lg transition-all duration-200 hover:from-red-600 hover:to-orange-600 hover:shadow-xl">
                    Registrati Gratis
                </a>
    ...
    <section class="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-32">
        <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div class="space-y-8 lg:order-1">
                <div
                    class="inline-flex items-center rounded-full border border-red-200/50 bg-linear-to-r from-red-100/80 to-orange-100/80 px-4 py-2 text-sm font-semibold text-red-700 backdrop-blur-sm dark:border-red-800/50 dark:from-red-900/30 dark:to-orange-900/30 dark:text-red-300">
                    🎥 La Tua Prossima Audizione Ti Aspetta
                </div>

                <h1
                    class="bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-5xl font-bold leading-tight text-transparent lg:text-7xl dark:from-white dark:to-gray-200">
                    CastingPro:<br>
                    <span
                        class="bg-linear-to-r from-gray-600 via-orange-500 to-yellow-500 bg-clip-text text-transparent">Il
                        Tuo</span><br>
                ...
                <div class="grid max-w-lg gap-4 md:grid-cols-2">
                    ...
                    <a href="{{ route('filament.admin.auth.register') }}"
                        class="hover:shadow-3xl group flex items-center justify-center space-x-3 rounded-2xl bg-linear-to-r from-red-500 to-orange-500 px-8 py-4 text-lg font-semibold text-white shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:from-red-600 hover:to-orange-600">
                        ...
                        <div class="carousel-slides h-full w-full overflow-hidden">
                            <div class="carousel-track flex transition-transform duration-700 ease-in-out"
                                ...
                                <div class="carousel-slide relative h-full w-full shrink-0">
                                    ...
                                    <div class="absolute bottom-8 left-8 text-white">
                                        <h3 class="mb-2 text-2xl font-bold">Service</h3>
    ...
    <section class="mx-auto max-w-7xl px-6 py-32 lg:px-8">
        <div class="mb-20 text-center">
            <h2
                class="bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-4xl font-bold text-transparent lg:text-5xl dark:from-white dark:to-gray-200 mb-6">
                Perché CastingPro?
            </h2>
        ...
        <div class="grid gap-8 md:grid-cols-3">
            <div
                class="group rounded-3xl border border-white/30 bg-white/50 p-8 text-center shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:border-white/50 hover:bg-white/70 hover:shadow-2xl dark:border-gray-700/50 dark:bg-gray-800/50 dark:hover:bg-gray-800/70">
                <div
                    class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-linear-to-r from-emerald-400 to-teal-500 shadow-xl transition-transform group-hover:scale-110">
                    <span class="text-2xl">🎯</span>
                </div>
                <h3 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">Matching Perfetto</h3>
                <p class="text-gray-600 dark:text-gray-300">Ricevi solo i casting perfetti per età, esperienza e tipo di
                    ruolo.</p>
            </div>
            ...
            <div
                class="group rounded-3xl border border-white/30 bg-white/50 p-8 text-center shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:border-white/50 hover:bg-white/70 hover:shadow-2xl dark:border-gray-700/50 dark:bg-gray-800/50 dark:hover:bg-gray-800/70">
                <div
                    class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-linear-to-r from-blue-400 to-indigo-500 shadow-xl transition-transform group-hover:scale-110">
                    <span class="text-2xl">⚡</span>
                </div>
                <h3 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">Visibilità Immediata</h3>
                <p class="text-gray-600 dark:text-gray-300">Il tuo profilo è online subito e visibile a tutti i casting
                    director.</p>
            </div>
            ...
            <div
                class="group rounded-3xl border border-white/30 bg-white/50 p-8 text-center shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:border-white/50 hover:bg-white/70 hover:shadow-2xl dark:border-gray-700/50 dark:bg-gray-800/50 dark:hover:bg-gray-800/70">
                <div
                    class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-linear-to-r from-purple-400 to-pink-500 shadow-xl transition-transform group-hover:scale-110">
                    <span class="text-2xl">🛡️</span>
                </div>
                <h3 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">100% Sicuro</h3>
                <p class="text-gray-600 dark:text-gray-300">Protezione dati GDPR, verifiche identità, pagamenti sicuri.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="mx-auto max-w-4xl px-6 py-20 text-center lg:px-8">
        <div class="rounded-3xl bg-linear-to-r from-black via-gray-800 to-black p-12 shadow-2xl lg:p-20">
            ...
            @if (Route::has('filament.admin.auth.register'))
            <a href="{{ route('filament.admin.auth.register') }}"
                class="inline-flex items-center rounded-2xl bg-white px-10 py-5 text-xl font-bold text-red-600 shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:bg-gray-50 hover:shadow-3xl">
    ...
    <div class="mx-auto max-w-md px-6 pb-12 text-center">
        <div
            ...
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Professionisti del Settore?</h3>
            <div class="space-y-2">
                <a href="{{ route('filament.admin.auth.login') }}"
                    class="block w-full rounded-xl border border-red-200 px-4 py-2 font-medium text-red-600 transition-all hover:border-red-300 hover:bg-red-50">
